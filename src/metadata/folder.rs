...
pub fn add_tags(doc: &mut FolderMetadata, mut files: HashSet<String>, tags: &[String]) -> Result {
...
pub fn remove_all_tags(doc: &mut FolderMetadata, mut files: HashSet<String>) -> Result {
    let item_count = doc.item_count();
